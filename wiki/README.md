...
| Page | What it is |
|---|---|
| [SPEC.md](../SPEC.md) | The generic spec: image in, one-hour video out. Start here. |
...
Jobs completed: **001-snow-tea** (snowy zen garden with tea steam and brazier fire) — final files are kept locally in `output/001-snow-tea/` (not in git, too large).
HTML versions of these pages: `docs/index.html`.
